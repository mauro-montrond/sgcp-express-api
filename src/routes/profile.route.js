...
router.get('/params', getProfilesSchema, awaitHandlerFactory(profileController.getProfilesByParams)); // localhost:3000/api/v1/profiles
...
router.get('/state/:state', awaitHandlerFactory(profileController.getProfilesByState)); // localhost:3000/api/v1/profiles/state/A
