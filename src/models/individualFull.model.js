...
class IndividualFullModel {
    ...
    findMany = async (params = {}, sorter) => {
        ...
        if(result.length) {
            ...
            else if(sorter == 'ID_CADASTRANTE_ANTECEDENTE'){
			...
			if(sorter == 'ID_CADASTRANTE_ANTECEDENTE'){
    ...
    addIndivRegister = (item) => {
		...
		indivRegister["AVATAR_CADASTRANTE_INDIVIDUO"] = null;
		...
		if(item.ID_CADASTRANTE_INDIVIDUO){
			...
			if(item.AVATAR_CADASTRANTE_INDIVIDUO)
				indivRegister["AVATAR_CADASTRANTE_INDIVIDUO"] = item.AVATAR_CADASTRANTE_INDIVIDUO;
    ...
    addPrecedentRegister = (item, origin) => {
		...
		precedentRegister["AVATAR_CADASTRANTE_ANTECEDENTE"] = null;
		...
		if(origin != 'precedentRegister'){
			if(item.ID_CADASTRANTE_ANTECEDENTE){
				...
				if(item.AVATAR_CADASTRANTE_ANTECEDENTE)
					precedentRegister["AVATAR_CADASTRANTE_ANTECEDENTE"] = item.AVATAR_CADASTRANTE_ANTECEDENTE;
			...
			if(item.ID_CADASTRANTE_INDIVIDUO){
				...
				if(item.AVATAR_CADASTRANTE_INDIVIDUO)
					precedentRegister["AVATAR_CADASTRANTE_ANTECEDENTE"] = item.AVATAR_CADASTRANTE_INDIVIDUO;
				if(item.PERFIL_CADASTRANTE_INDIVIDUO)
